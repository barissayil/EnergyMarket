...
class Market(Process):
	...
	def handleRequest(self,msg):
		...
		if msg=='Broke':
			...
			print('Market: A home has gone bankrupt. There are {} homes in the market at the moment.'.format(self.numberOfHomes))
			...
			self.numberOfHomes+=1
			print('Market: New home. There are {} homes in the market at the moment.'.format(self.numberOfHomes))



	def run(self):
		requestLook = Thread(self.lookAtRequests())
		requestLook.start()
