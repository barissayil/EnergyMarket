...
class Home(Process):
    ...
    def __init__(self,productionRate, consumptionRate):
        ...
        self.messageQueueList.append(MessageQueue(0))
...
class Market(Process):
    ...
    def __init__(self):
        ...
        self.price=20
        self.messageQueueList=[]
        self.messageQueueList.append(MessageQueue(0,IPC_CREAT))
...
if __name__=="__main__":
    ...
    test1=MessageQueue(1000,IPC_CREAT)
    test1.remove()
    sleep(1)
    for i in range(5):
        test1=MessageQueue(i,IPC_CREAT)
        test1.remove()
        sleep(1)
    market=Market()
    market.start()
